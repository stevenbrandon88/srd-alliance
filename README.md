...
For the Python tester, React dashboard, Monte Carlo engine, and full audit trail — use [srd-barbados](https://github.com/stevenbrandon88/srd-barbados). This repo is the deliverable set for ministers, officials, and briefing rooms.
